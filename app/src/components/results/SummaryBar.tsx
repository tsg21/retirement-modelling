  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
      <div className="rounded-lg border border-border bg-card p-3">
        ...
        {isCoupleMode && <div className="text-xs text-muted-foreground mt-1">A: {partnerARetirementAge} · B: {partnerBRetirementAge}</div>}
      </div>
      <div className="rounded-lg border border-border bg-card p-3">
      ...
      <div className="rounded-lg border border-border bg-card p-3">
        ...
        {isCoupleMode && partnerBPot > 0 && <div className="text-xs text-muted-foreground mt-1">A: {formatMoney(partnerAPot)} · B: {formatMoney(partnerBPot)}</div>}
      </div>
    </div>
  )
}
